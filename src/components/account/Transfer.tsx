...
export default function Transfer({
    ...
    const onSubmitSavingsWithdrawal = async () => {
        ...
        //heck if sendercurrency matches beneficiary currency
        if (senderAccount.currency_code !== benefiaryAccount.currency_code) {
            toast.error("Sender and beneficiary currencies do not match", {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        //check if sender account number and beneficiary account number is same
        if (accountNumber === benefiaryAccountNumber) {
            toast.error("Sender and beneficiary account numbers cannot be same", {
                position: "top-right",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
